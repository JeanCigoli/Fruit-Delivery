...
-- -----------------------------------------------------
-- Schema fruit_delivery
-- -----------------------------------------------------

-- -----------------------------------------------------
-- Schema fruit_delivery
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `fruit_delivery` DEFAULT CHARACTER SET utf8 ;
USE `fruit_delivery` ;

-- -----------------------------------------------------
-- Table `fruit_delivery`.`tb_state`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `fruit_delivery`.`tb_state` (
...
INSERT INTO `tb_state` (`id_state`, `name`, `uf`) VALUES
(1, 'Acre', 'AC'),
(2, 'Alagoas', 'AL'),
(3, 'Amazonas', 'AM'),
(4, 'Amapá', 'AP'),
...
-- -----------------------------------------------------
-- Table `fruit_delivery`.`tb_city`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `fruit_delivery`.`tb_city` (
  ...
  `updated_at` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id_city`),
  INDEX `fk_tb_city_tb_state_idx` (`id_state` ASC) VISIBLE,
  CONSTRAINT `fk_tb_city_tb_state`
    FOREIGN KEY (`id_state`)
    REFERENCES `fruit_delivery`.`tb_state` (`id_state`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `fruit_delivery`.`tb_address`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `fruit_delivery`.`tb_address` (
  ...
  INDEX `fk_tb_address_tb_city1_idx` (`id_city` ASC) VISIBLE,
  CONSTRAINT `fk_tb_address_tb_city1`
    FOREIGN KEY (`id_city`)
    REFERENCES `fruit_delivery`.`tb_city` (`id_city`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `fruit_delivery`.`tb_client`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `fruit_delivery`.`tb_client` (
...
-- -----------------------------------------------------
-- Table `fruit_delivery`.`tb_rel_client_address`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `fruit_delivery`.`tb_rel_client_address` (
  `id_rel_client_address` INT NOT NULL AUTO_INCREMENT,
  `id_address` INT NOT NULL,
  `id_client` INT NOT NULL,
  PRIMARY KEY (`id_rel_client_address`),
  INDEX `fk_tb_rel_client_address_tb_address1_idx` (`id_address` ASC) VISIBLE,
  INDEX `fk_tb_rel_client_address_tb_client1_idx` (`id_client` ASC) VISIBLE,
  CONSTRAINT `fk_tb_rel_client_address_tb_address1`
    FOREIGN KEY (`id_address`)
    REFERENCES `fruit_delivery`.`tb_address` (`id_address`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_tb_rel_client_address_tb_client1`
    FOREIGN KEY (`id_client`)
    REFERENCES `fruit_delivery`.`tb_client` (`id_client`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `fruit_delivery`.`tb_company`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `fruit_delivery`.`tb_company` (
...
-- -----------------------------------------------------
-- Table `fruit_delivery`.`tb_rel_company_address`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `fruit_delivery`.`tb_rel_company_address` (
  `id_rel_company_address` INT NOT NULL AUTO_INCREMENT,
  `id_company` INT NOT NULL,
  `id_address` INT NOT NULL,
  PRIMARY KEY (`id_rel_company_address`),
  INDEX `fk_tb_rel_company_address_tb_company1_idx` (`id_company` ASC) VISIBLE,
  INDEX `fk_tb_rel_company_address_tb_address1_idx` (`id_address` ASC) VISIBLE,
  CONSTRAINT `fk_tb_rel_company_address_tb_company1`
    FOREIGN KEY (`id_company`)
    REFERENCES `fruit_delivery`.`tb_company` (`id_company`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_tb_rel_company_address_tb_address1`
    FOREIGN KEY (`id_address`)
    REFERENCES `fruit_delivery`.`tb_address` (`id_address`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `fruit_delivery`.`tb_expenditure_type`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `fruit_delivery`.`tb_expenditure_type` (
  `id_expenditure_type` INT NOT NULL AUTO_INCREMENT,
  `type` VARCHAR(50) NOT NULL,
  `created_at` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id_expenditure_type`))
ENGINE = InnoDB;


-- -----------------------------------------------------
-- Table `fruit_delivery`.`tb_expenditure`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `fruit_delivery`.`tb_expenditure` (
  `id_expenditure` INT NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(50) NOT NULL,
  `value` DOUBLE(10,2) NOT NULL,
  `id_expenditure_type` INT NOT NULL,
  `id_company` INT NOT NULL,
  `created_at` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id_expenditure`),
  INDEX `fk_tb_expenditure_tb_expenditure_type1_idx` (`id_expenditure_type` ASC) VISIBLE,
  INDEX `fk_tb_expenditure_tb_company1_idx` (`id_company` ASC) VISIBLE,
  CONSTRAINT `fk_tb_expenditure_tb_expenditure_type1`
    FOREIGN KEY (`id_expenditure_type`)
    REFERENCES `fruit_delivery`.`tb_expenditure_type` (`id_expenditure_type`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_tb_expenditure_tb_company1`
    FOREIGN KEY (`id_company`)
    REFERENCES `fruit_delivery`.`tb_company` (`id_company`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `fruit_delivery`.`tb_payment_type`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `fruit_delivery`.`tb_payment_type` (
...
-- -----------------------------------------------------
-- Table `fruit_delivery`.`tb_sale`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `fruit_delivery`.`tb_sale` (
  ...
  `updated_at` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id_sale`),
  INDEX `fk_tb_sale_tb_payment_type1_idx` (`id_payment_type` ASC) VISIBLE,
  INDEX `fk_tb_sale_tb_client1_idx` (`id_client` ASC) VISIBLE,
  CONSTRAINT `fk_tb_sale_tb_payment_type1`
    FOREIGN KEY (`id_payment_type`)
    REFERENCES `fruit_delivery`.`tb_payment_type` (`id_payment_type`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `fruit_delivery`.`tb_purchase`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `fruit_delivery`.`tb_purchase` (
  ...
  INDEX `fk_tb_purchase_tb_company1_idx` (`id_company` ASC) VISIBLE,
  INDEX `fk_tb_purchase_tb_payment_type1_idx` (`id_payment_type` ASC) VISIBLE,
  CONSTRAINT `fk_tb_purchase_tb_company1`
    FOREIGN KEY (`id_company`)
    REFERENCES `fruit_delivery`.`tb_company` (`id_company`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_tb_purchase_tb_payment_type1`
    FOREIGN KEY (`id_payment_type`)
    REFERENCES `fruit_delivery`.`tb_payment_type` (`id_payment_type`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `fruit_delivery`.`tb_product_type`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `fruit_delivery`.`tb_product_type` (
...
-- -----------------------------------------------------
-- Table `fruit_delivery`.`tb_product_unit`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `fruit_delivery`.`tb_product_unit` (
  `id_product_unit` INT NOT NULL AUTO_INCREMENT,
...
INSERT INTO tb_product_unit VALUES 
(NULL, 'Quilograma', 'kg', NOW()),
(NULL, 'Unidade', 'un', NOW()),
(NULL, 'Grama', 'g', NOW()),
(NULL, 'Litros', 'l', NOW());
...
-- -----------------------------------------------------
-- Table `fruit_delivery`.`tb_product`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `fruit_delivery`.`tb_product` (
  `id_product` INT NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(100) NOT NULL,
  `valueBuy` DOUBLE(10,2) NOT NULL,
  `valueSale` DOUBLE(10,2) NOT NULL,
  ...
  INDEX `fk_tb_product_tb_product_type1_idx` (`id_product_type` ASC) VISIBLE,
  CONSTRAINT `fk_tb_product_tb_product_type1`
    FOREIGN KEY (`id_product_type`)
    REFERENCES `fruit_delivery`.`tb_product_type` (`id_product_type`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  INDEX `fk_tb_product_tb_product_unit1_idx` (`id_product_unit` ASC) VISIBLE,
  CONSTRAINT `fk_tb_product_tb_product_unit1`
    FOREIGN KEY (`id_product_unit`)
    REFERENCES `fruit_delivery`.`tb_product_unit` (`id_product_unit`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `fruit_delivery`.`tb_rel_purchase_product`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `fruit_delivery`.`tb_rel_purchase_product` (
  `id_rel_purchase_product` INT NOT NULL AUTO_INCREMENT,
  `quantity` DOUBLE NOT NULL,
  `id_product` INT NOT NULL,
  `id_purchase` INT NOT NULL,
  PRIMARY KEY (`id_rel_purchase_product`),
  INDEX `fk_tb_rel_purchase_product_tb_product1_idx` (`id_product` ASC) VISIBLE,
  INDEX `fk_tb_rel_purchase_product_tb_purchase1_idx` (`id_purchase` ASC) VISIBLE,
  CONSTRAINT `fk_tb_rel_purchase_product_tb_product1`
    FOREIGN KEY (`id_product`)
    REFERENCES `fruit_delivery`.`tb_product` (`id_product`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_tb_rel_purchase_product_tb_purchase1`
    FOREIGN KEY (`id_purchase`)
    REFERENCES `fruit_delivery`.`tb_purchase` (`id_purchase`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `fruit_delivery`.`tb_rel_sale_product`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `fruit_delivery`.`tb_rel_sale_product` (
  `id_rel_sale_product` INT NOT NULL AUTO_INCREMENT,
  `quantity` DOUBLE NOT NULL,
  `id_sale` INT NOT NULL,
  `id_product` INT NOT NULL,
  PRIMARY KEY (`id_rel_sale_product`),
  INDEX `fk_tb_rel_sale_product_tb_sale1_idx` (`id_sale` ASC) VISIBLE,
  INDEX `fk_tb_rel_sale_product_tb_product1_idx` (`id_product` ASC) VISIBLE,
  CONSTRAINT `fk_tb_rel_sale_product_tb_sale1`
    FOREIGN KEY (`id_sale`)
    REFERENCES `fruit_delivery`.`tb_sale` (`id_sale`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_tb_rel_sale_product_tb_product1`
    FOREIGN KEY (`id_product`)
    REFERENCES `fruit_delivery`.`tb_product` (`id_product`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `fruit_delivery`.`tb_inventory`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `fruit_delivery`.`tb_inventory` (
  `id_inventory` INT NOT NULL AUTO_INCREMENT,
  `quantity` DOUBLE NOT NULL,
  `id_product` INT NOT NULL,
  `updated_at` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id_inventory`),
  INDEX `fk_tb_inventory_tb_product1_idx` (`id_product` ASC) VISIBLE,
  CONSTRAINT `fk_tb_inventory_tb_product1`
    FOREIGN KEY (`id_product`)
    REFERENCES `fruit_delivery`.`tb_product` (`id_product`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
